...
target_script=/home/fct/Project/Builds/Ballerina/aggregator-with-db-caching-one/start.sh
target_uptime_script=/home/fct/Project/Builds/Ballerina/aggregator-with-db-caching-one/uptime.sh
target_uptime_path=/home/fct/Project/Builds/Ballerina/aggregator-with-db-caching-one/uptime_dir

###Machine A
host1_ip=172.16.53.57
host1_port=8080
host1_username_ip=fct@172.16.53.57
host1_pwd=123
host1_machine_num=1

###Machine B
host2_ip=172.16.53.53
host2_port=8081
host2_username_ip=fct@172.16.53.53
host2_pwd=123
host2_machine_num=2
...
jtl_location=/home/fct/Projects/ballerina-0-981-1/Results/aggregator-with-db-caching-one/jtls
jmx_file=/home/fct/Projects/ballerina-0-981-1/Tests/aggregator-with-db-caching-one/Aggregator_One_DB_Test.jmx
uptime_path=/home/fct/Projects/ballerina-0-981-1/Results/aggregator-with-db-caching-one
...
# Generating JTL files
		...
		do
			...
			do
				echo "Checking service"
				response_code=$(curl -s -o /dev/null -w "%{http_code}" -X GET http://${host2_ip}:${host2_port}/serviceNews/test)
				if [ $response_code -eq 200 ]; then
