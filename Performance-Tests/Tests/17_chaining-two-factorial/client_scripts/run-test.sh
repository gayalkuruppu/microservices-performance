...
###Machine B
host2_ip=172.16.53.54
host2_port=8081
host2_username_ip=fct@172.16.53.54
host2_pwd=123
host2_machine_num=2
...
jmx_file=/home/fct/Projects/ballerina-0-981-1/Tests/factorial-chaining-two/Chaining_Two_Factorial_Test.jmx
...
for size in ${message_sizes[@]}
	do
		...
		do
			...
			do
				echo "Checking service"
				response_code=$(curl -s -o /dev/null -w "%{http_code}" -X GET http://${host2_ip}:${host2_port}/prime/test)
				if [ $response_code -eq 200 ]; then
