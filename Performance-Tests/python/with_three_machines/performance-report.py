...
for size in message_sizes:
	for user in concurrent_users:
		...
		uptime_file_name1 = uptime_reports_root+"/uptime_dir/"+"1_machine_"+str(user)+"_Users_"+str(size)+"_size_uptime.txt"
		uptime_file_name2 = uptime_reports_root+"/uptime_dir/"+"2_machine_"+str(user)+"_Users_"+str(size)+"_size_uptime.txt"
		uptime_file_name3 = uptime_reports_root+"/uptime_dir/"+"3_machine_"+str(user)+"_Users_"+str(size)+"_size_uptime.txt"
		...
		row = [size,user, average_latency, min_latency, max_latency, percentile_90, percentile_95, percentile_99, throughput, error_rate, A_last_one_minutes_la, A_last_five_minutes_la, A_last_fifteen_minutes_la, B_last_one_minutes_la, B_last_five_minutes_la, B_last_fifteen_minutes_la, C_last_one_minutes_la, C_last_five_minutes_la, C_last_fifteen_minutes_la]
