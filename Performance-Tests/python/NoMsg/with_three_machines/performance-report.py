...
concurrent_users = [1, 2, 50, 100, 300, 500, 700, 1000]#1, 2, 50, 100, 300, 500, 700, 1000
message_sizes= [50, 400, 1024]#400, 10240
...
for user in concurrent_users:
	...
	uptime_file_name1 = uptime_reports_root+"/uptime_dir/"+"1_machine_"+str(user)+"_Users_uptime.txt"
	uptime_file_name2 = uptime_reports_root+"/uptime_dir/"+"2_machine_"+str(user)+"_Users_uptime.txt"
	uptime_file_name3 = uptime_reports_root+"/uptime_dir/"+"3_machine_"+str(user)+"_Users_uptime.txt"
	...
	C_load_averages = getLoadAverages(uptime_file_name3)
	C_last_one_minutes_la = C_load_averages[1]
	C_last_five_minutes_la = C_load_averages[5]
	C_last_fifteen_minutes_la = C_load_averages[15]
	...
	row = [user, average_latency, min_latency, max_latency, percentile_90, percentile_95, percentile_99, throughput, error_rate, A_last_one_minutes_la, A_last_five_minutes_la, A_last_fifteen_minutes_la, B_last_one_minutes_la, B_last_five_minutes_la, B_last_fifteen_minutes_la, C_last_one_minutes_la, C_last_five_minutes_la, C_last_fifteen_minutes_la]
