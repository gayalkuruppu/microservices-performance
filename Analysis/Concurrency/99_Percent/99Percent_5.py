...
category_1 = sys.argv[6]
category_2 = sys.argv[7]
category_3 = sys.argv[8]
category_4 = sys.argv[9]
category_5 = sys.argv[10]
plot_title = sys.argv[11]
...
plt.legend([category_1, category_2, category_3, category_4, category_5])
