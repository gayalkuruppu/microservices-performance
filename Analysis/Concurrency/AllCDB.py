...
jtl_location="/media/jayathma/OS/Jayathma_R/Results/DB-Chain/DB"
summary_location="/media/jayathma/PartitionE/Jayathma_R/TransformedCSV/ChainDB"
output_csv_location="/media/jayathma/PartitionE/Jayathma_R/TransformedCSV/ChainDB/chain.csv"
...
for num in num_services:
	...
	for user in concurrent_users:
		...
		jtl_file_name = jtl_location+"/"+str(num)+"_chaindb/jtls/"+str(user)+"_users/results-measurement.jtl"
