...
message_sizes=[521, 7919, 10007,100003,1000003,10000019]
num_services=[1, 2, 3]

#CSV file
csv_file_records = []
headers = ['Prime Number', 'Num Service', 'Users', 'Throughput','Avg_Latency', 'percentile_10', 'percentile_50', 'percentile_90', 'percentile_99', 'percentile_99.9','percentile_99.99','Std','Tail Index']
csv_file_records.append(headers)

#For testing
#concurrent_users=[1000] 
#message_sizes=[10000019]
#num_services=[1]
...
jtl_location="/media/jayathma/PartitionE/Jayathma_R/prime-chain"
summary_location="/media/jayathma/PartitionE/Jayathma_R/TransformedCSV/prime/chain"
output_csv_location="/media/jayathma/PartitionE/Jayathma_R/prime-chain/chain.csv"
...
for size in message_sizes:
	print ("Analysis for " + str(size) + " prime number")
	
	for num in num_services:
		
		for user in concurrent_users:
			
			jtl_file_name = jtl_location+"/"+str(num)+"_Chain/jtls/"+str(size)+"_message/"+str(user)+"_users/results-measurement.jtl"
